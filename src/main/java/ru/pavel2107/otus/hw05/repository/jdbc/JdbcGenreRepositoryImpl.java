...
public class JdbcGenreRepositoryImpl implements GenreRepository {
    ...
    private final String INSERT_QUERY = "INSERT INTO genre(  name) values( :name)";
    private final String UPDATE_QUERY = "UPDATE genre SET name = :name where id = :id";
    private final String DELETE_QUERY = "DELETE FROM genre WHERE id = :id";
    private final String FIND_BY_ID   = "SELECT * FROM genre where id = :id";
